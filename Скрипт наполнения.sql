...
CREATE TABLE `discounts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL COMMENT 'Ключ на пользователя',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Название скидки',
  `discount` int(10) unsigned NOT NULL COMMENT 'Скидка',
...
CREATE TABLE `orders` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL COMMENT 'Ключ на пользователя',
  `status` enum('Обрабатывается','Готовится','Передан курьеру','Отменен') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Статус заказа',
  `payment` enum('Наличными','Картой') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Способ оплаты',
...
CREATE TABLE `orders_pizzas` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) unsigned NOT NULL COMMENT 'Ключ на заказ',
  `pizza_id` bigint(20) unsigned NOT NULL COMMENT 'Ключ на пиццу',
  `count` int(10) unsigned NOT NULL COMMENT 'Количество заказа',
  PRIMARY KEY (`id`),
...
CREATE TABLE `pizzas` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Название пиццы',
  `composition` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Состав пиццы',
  `price` int(10) unsigned NOT NULL COMMENT 'Цена пиццы',
  `size` enum('Большая','Средняя','Маленькая') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Таблица топпингов для конкретной пиццы';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pizzas_toppings` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5),(6,6,6),(7,7,7),(8,8,8),(9,9,9),(10,10,10);
...
CREATE TABLE `pizzerias` (
  ...
  `city_id` bigint(20) unsigned NOT NULL COMMENT 'Ключ на город',
  PRIMARY KEY (`id`),
  KEY `city_id` (`city_id`),
...
CREATE TABLE `profiles` (
  ...
  `password` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Пароль пользователя',
...
CREATE TABLE `toppings` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Название топпинга',
  PRIMARY KEY (`id`)
...
INSERT INTO `toppings` VALUES (1,'autem'),(2,'explicabo'),(3,'ullam'),(4,'unde'),(5,'corporis'),(6,'corrupti'),(7,'ut'),(8,'aut'),(9,'libero'),(10,'quam');
...
CREATE TABLE `users` (
  ...
  `lastname` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Фамилия пользователя',
  `surname` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Отчество пользователя (заполнение необязательно)',
  `address` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Адрес пользователя',
  `phone` bigint(20) unsigned NOT NULL COMMENT 'Телефон пользователя',
  `email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'почта пользователя (заполнение необязательно)',
  PRIMARY KEY (`id`),
  KEY `users_lastname` (`lastname`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Таблица пользователей сервиса';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-16  3:17:18
